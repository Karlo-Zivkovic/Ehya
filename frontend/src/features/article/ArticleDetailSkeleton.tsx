function ArticleDetailSkeleton() {
  return (
    <div
      className={`rounded-xl overflow-hidden shadow-[rgba(7,_65,_210,_0.1)_0px_9px_30px] w-full animate-pulse p-6`}
    >
      {/* image */}
        ...
        <div className="flex justify-between flex-nowrap items-center mt-6">
          <div className="flex items-center gap-x-2 md:gap-x-2.5">
            ...
            <div className="flex flex-col">
              ...
              {/* verified status */}
              <div className="w-16 h-2 mt-4 bg-slate-300 rounded-lg" />
            </div>
          </div>
          {/* date */}
